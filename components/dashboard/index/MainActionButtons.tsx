  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <div className="bg-neutral-100 dark:bg-neutral-800 dark:hover:bg-opacity-65 hover:bg-opacity-65 hover:cursor-pointer gap-3 flex items-center shadow rounded-2xl p-4">
