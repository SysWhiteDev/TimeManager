...
export default async function Page({ searchParams }: any) {
  ...
  return (
    <div className="max-w-6xl lg:px-4 sm:px-0 mx-auto pt-[5dvh] lg:pt-[10dvh] pb-8">
      ...
      <div className="bg-neutral-100 dark:bg-neutral-800 grid-cols-1 lg:grid-cols-3 dark:border-neutral-700 grid gap-1.5 border border-white p-2 rounded-xl mt-4">
